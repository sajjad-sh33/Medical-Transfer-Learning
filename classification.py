...
#########################################################################################
        elif "vit_" in parameters.foundation_params.backbone_type:
            wrapper = MAEWrapper(parameters)
        elif "aimv2" in parameters.foundation_params.backbone_type:
            wrapper = aimv2Wrapper(parameters)
        elif "coca" in parameters.foundation_params.backbone_type:
            wrapper = cocaWrapper(parameters)
        elif "sam2" in parameters.foundation_params.backbone_type:
            wrapper = SAM2Wrapper(parameters)
        elif "VMamba" in parameters.foundation_params.backbone_type:
            wrapper = VMambaWrapper(parameters)
#########################################################################################
