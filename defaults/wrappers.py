...
class SAMWrapper(DefaultWrapper):
    ...
    def init_model(self):      
        ...
        return model
#######################################################################################################
class SAM2Wrapper(DefaultWrapper):
    def __init__(self, parameters,):
        super().__init__(parameters)       
    ...
    def init_model(self):      
        ...
        # INIT Ymodel model
        model = Ymodel_sam2(self.parameters, foundation_model, main_model)   
        if ddp_is_on():
            model = DDP(model, device_ids=[self.device_id], find_unused_parameters=False)
...
class VMambaWrapper(DefaultWrapper):
    def __init__(self, parameters,):
        super().__init__(parameters)       
...
class MAEWrapper(DefaultWrapper):
    def __init__(self, parameters,):
        super().__init__(parameters)       
    ...
    def init_model(self):      
        ...
        # INIT Ymodel model
        model = Ymodel_MAE(self.parameters, foundation_model, main_model)   
        if ddp_is_on():
            model = DDP(model, device_ids=[self.device_id], find_unused_parameters=False)
        return model
...
class aimv2Wrapper(DefaultWrapper):
    def __init__(self, parameters,):
        super().__init__(parameters)       
    ...
    def init_model(self):      
        ...
        # INIT Ymodel model
        model = Ymodel_aimv2(self.parameters, foundation_model, main_model)   
        if ddp_is_on():
            model = DDP(model, device_ids=[self.device_id], find_unused_parameters=False)
        return model
...
class cocaWrapper(DefaultWrapper):
    def __init__(self, parameters,):
        super().__init__(parameters)       
    ...
    def init_model(self):      
        ...
        # INIT Ymodel model
        model = Ymodel_coca(self.parameters, foundation_model, main_model)   
        if ddp_is_on():
            model = DDP(model, device_ids=[self.device_id], find_unused_parameters=False)
        return model
#######################################################################################################
